  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CartBloc, CartState>(
      builder: (context, State) {
        ...
        final deliveryFee = State is CartLoaded ? State.deliveryFee : 0.0;
        final grandTotal = State is CartLoaded ? State.grandTotal : 0.0;
        return Scaffold(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        context.read<CartBloc>().add(UpdateCartQuantity(item.product.id,quantity: item.quantity-1));
                                        // setState(() {
